...
public class Utils {
     ...
     */
    public final static int escape(final StringBuilder out, final char ch,
	    final int pos) {
	switch (ch) {
	case '\\':
	case '[':
     ...
     */
    public final static int readUntil(final StringBuilder out, final String in,
	    final int start, final char... end) {
	int pos = start;
	while (pos < in.length()) {
     ...
     */
    public final static int readMdLinkId(final StringBuilder out,
	    final String in, final int start) {
	int pos = start;
	int counter = 1;
	while (pos < in.length()) {
    ...
    public final static int readRawUntil(final StringBuilder out,
	    final String in, final int start, final char... end) {
	int pos = start;
	while (pos < in.length()) {
	    final char ch = in.charAt(pos);
	    boolean endReached = false;
     ...
     * @return The new position or -1 if no 'end' char was found.
     */
    public final static int readXMLUntil(final StringBuilder out,
	    final String in, final int start, final char... end) {
	int pos = start;
    ...
    public final static void appendCode(final StringBuilder out,
	    final String in, final int start, final int end) {
     ...
     *            The character.
     */
    public final static void appendDecEntity(final StringBuilder out,
	    final char value) {
	out.append("&#");
     ...
     *            The character.
     */
    public final static void appendHexEntity(final StringBuilder out,
	    final char value) {
	out.append("&#x");
     ...
     *            Input String end position.
     */
    public final static void appendMailto(final StringBuilder out,
	    final String in, final int start, final int end) {
	for (int i = start; i < end; i++) {
	    final char c;
	    final int r = rnd();
     ...
     */
    public final static int readXML(final StringBuilder out, final String in,
	    final int start, final boolean safeMode) {
	int pos;
     ...
     */
    public final static void codeEncode(final StringBuilder out,
	    final String value, final int offset) {
